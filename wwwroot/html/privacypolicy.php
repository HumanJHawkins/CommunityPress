...
<p>
    ...
    collected by <?= $GLOBALS['SITE_NAME'] ?>'s website, <a
...
<p>
    We use your personal information to provide you with personalized service; to send e-mail alerts to
    you; to answer your requests; to process your membership application; etc. You may choose to opt out
    at any time, which will cease all communications from us. We may also use your information or a unique
    numeric ID to track visitation to our website, to restrict content or feature reviews to a single
    review per account, to understand which of our features are the most popular so we can better
    serve our users' needs, and to conduct analysis related improving user experience with our site.
</p>
...
<h2>Modifications</h2>
<p>
    We may amend this privacy policy from time to time; please review it periodically. We maintain the
    option to modify this privacy at any time by electronic notice posted on our website. Your continued
    use of our website after the date that such notices are posted will be deemed to be your agreement
